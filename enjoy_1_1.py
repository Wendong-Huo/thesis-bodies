...
def main(train_body_id, run, test_body_id):  # noqa: C901
    ...
    record = enjoy(
        stats_path=f"experiment_results/logs_3x100/{train_body_id}_{run}/ppo/Walker2Ds-v0_1/Walker2Ds-v0", 
        model_path=f"experiment_results/logs_3x100/{train_body_id}_{run}/ppo/Walker2Ds-v0_1/best_model.zip", 
...
if __name__ == "__main__":
    with open("experiment_results/read_tb_3x100.pickle", "rb") as f:
