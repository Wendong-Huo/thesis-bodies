...
def one_exp(num_train_bodies):
    ...
    for i in range(5):
        ...
        for j in range(5):
            ...
            print(f"sbatch -J ra_b{num_train_bodies} submit.sh python 1.train.py --seed={seed} --train_bodies={str_body_selected} --test_bodies={str_body_selected} --topology_wrapper=CustomAlignWrapper --custom_alignment={custom_alignment} --tensorboard=tensorboard_ra_b{num_train_bodies}")

            g_all_jobs[g_current_exp_id] = {
                "num_train_bodies": num_train_bodies,
...
for i in range(5):
    one_exp(num_train_bodies=2)

for i in range(5):
    one_exp(num_train_bodies=4)

for i in range(5):
    one_exp(num_train_bodies=8)

for i in range(5):
    one_exp(num_train_bodies=16)
