# 300s are the variations of Walker2D
# 400s are the variations of HalfCheetah
# 500s are the variations of Ant
# 600s are the variations of Hopper
...
body_folder = str(Path("output_data/bodies_pretrain").resolve())
...
def make_body(body, mutate_seed=0):
    ...
    if mutate_seed>0:
        ...
        with seeds.temp_seed(body+mutate_seed):
