...
class MyWalker2D(MyWalkerBase):
    ...
    def __init__(self, xml):
        MyWalkerBase.__init__(self, xml, "torso", action_dim=6, obs_dim=22, power=0.40)
    ...
    def robot_specific_reset(self, bullet_client):
        MyWalkerBase.robot_specific_reset(self, bullet_client)
...
class MyWalker2DBulletEnv(MyWalkerBaseBulletEnv):
    ...
    def __init__(self, xml, render=False):
        ...
        self.xml = xml
        MyWalkerBaseBulletEnv.__init__(self, self.robot, render)
