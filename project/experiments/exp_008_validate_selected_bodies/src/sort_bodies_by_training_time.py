...
for body_base in args.train_bodies:
    ...
    os.makedirs("output_data/selected_bodies", exist_ok=True)
    
    re_index = {3:0,4:0,5:0,6:0}
    for body in selected_bodies:
        body = int(body)
        body_type = body//100
        shutil.copy(f"output_data/bodies/{body}.xml", f"output_data/selected_bodies/{body_type*100+re_index[body_type]}.xml")
