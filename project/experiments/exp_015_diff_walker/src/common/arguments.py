...
def get_args():
    ...
    parser.add_argument("--topologies", type=str, default="", help="Switch for different experiments. Could be: same|diff")
    parser.add_argument("--wrapper_type", type=str, default="Walker2DHopperWrapper", help="special wrapper for different experiments.")
